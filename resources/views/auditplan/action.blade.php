<a href="{{ $url_print }}" class="btn btn-info btn-sm" title="Print Preview: {{ $model->objektif_audit }}"><i class="fas fa-print"></i></a></a>
<a href="{{ $url_show }}" class="btn btn-success btn-sm" title="Confirm: {{ $model->objektif_audit }}"><i class="fas fa-check"></i></a></a>
