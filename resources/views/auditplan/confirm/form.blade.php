        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    {!! Form::textarea('objektif_audit', null, ['class' => 'form-control' .
                    ($errors->has('objektif_audit')? ' is-invalid': ''), 'id' => 'objektif_audit', 'rows' => 3]) !!}
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('klausul', null, ['class' => 'form-control'. ($errors->has('klausul')? ' is-invalid':
                    ''), 'id' => 'klausul']) !!}
                    @error('klausul')
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-control {{ $errors->has('departement_id')? ' is-invalid': '' }}"
                                ...
                                <option {{ $model->departement->id == $dept->id ? "selected" : "" }}
                                    value="{{ $dept->id }}" data-kadept="{{ $dept->user->name }}">
                                    {{ $dept->name }}
                                </option>
                                @else
                            ...
                            <div id="error-departement_id" class="invalid-feedback">
                                {{ $errors->first('departement_id') }}</div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            @if ($model->exists)
                            {!! Form::text('kadept', ($model->exists ? $model->departement->user->name : null), ['class'
                            => 'form-control', 'id' => 'kadept', 'disabled']) !!}
                            @else
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    ['class' => 'form-control' . ($errors->has('auditee_id') ? ' is-invalid': ''), 'id' => 'auditee_id',
                ...
                <div class="form-group">
                    ...
                    ['class' => 'form-control' . ($errors->has('auditor_id') ? ' is-invalid': ''), 'id' => 'auditor_id',
                    'placeholder' => 'Please Select'])
                    !!}
                ...
                <div class="form-group">
                    ...
                    ['class' => 'form-control' . ($errors->has('auditor_leader_id') ? ' is-invalid': ''), 'id' =>
                    'auditor_leader_id', 'placeholder' => 'Please Select'])
                    !!}
                    <div id="error-auditor_leader_id" class="invalid-feedback">{{ $errors->first('auditor_leader_id') }}
                    </div>
                </div>
            </div>
            <!-- /.card-body -->
